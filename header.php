                            ...
                            <ul class="nav navbar-nav">
                                ...
                                <li class="dropdown"><a class="dropdown-toggle nav-link dropdown-toggle" data-toggle="dropdown" aria-expanded="false" href="">Catégories </a>
                                    <div class="dropdown-menu" role="menu">
                                        ...
                                        <a class="dropdown-item" role="presentation" href="#">Le Chantier Naval</a>
                                        <a class="dropdown-item" role="presentation" href="#">La Parc National des Calanques</a>
                                    </div>
                                </li>
                            </ul>
                ...
                <div class="container hero">
                    <div class="row">
                        <div class="col-md-8 offset-md-2">
                            <h1 class="text-center">Civitatensis</h1>
